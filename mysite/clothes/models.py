...
#     product_slug = models.SlugField(Item)
#     qty = models.PositiveIntegerField(default=1)
#     item_total = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
#
#
# def __str__(self):
#     return "Cart item for product {0}".format(self.item.name)
#
#
...
#         return str(self.id)
#
#     def add_to_cart(self, item_slug):
#         cart = self
#         product = Item.objects.get(slug=item_slug)
#         new_item, _ = CartItem.objects.get_or_create(product_slug=product_slug)
